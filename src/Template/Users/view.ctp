...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Home'), ['controller'=>'Admin','action' => 'edit', $user->user_id]) ?> </li>
...
<div class="users view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('User Full Name') ?></th>
            <td><?= h($user->user_full_name) ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?= $user->has('department') ? $this->Html->link($user->department->department_id, ['controller' => 'Departments', 'action' => 'view', $user->department->department_id]) : '' ?></td>
        </tr>
        <tr>
